...
*/
    ...
    function vizStixWrapper(content) {
      cfg = {
        iconDir: "static/nbextensions/stix2viz/stix2viz/icons"
      }
    ...
    function populateLegend(typeGroups) {
      ...
      typeGroups.forEach(function(typeName) {
        ...
        key.style.backgroundImage = "url('static/nbextensions/stix2viz/stix2viz/icons/stix2_" + typeName.replace(/\-/g, '_') + "_icon_tiny_round_v1.png')";
    ...
    function resetPage() {
      ...
      if (header.classList.contains('linkish')) {
       ...
       // document.getElementById('files').value = ""; // reset the files input
        ...
        selectedContainer.innerHTML = ""; // reset the selection container
